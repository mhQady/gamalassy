		...
		<div id="hero">
			<div id="hero-styles">
				<div id="hero-caption" class="text-align-left">
					<div class="inner">
						<div class="hero-title"><span><?php single_cat_title('', true); ?></span></div>
                        <div class="hero-subtitle"><span><?php echo esc_html__( 'Category Results', 'rayden'); ?></span></div> 
					</div>
				</div>
			</div>
		</div>
			...
			<div id="blog" class="<?php echo sanitize_html_class( $rayden_blog_layout ); ?>">
				...
				<?php 
					...
					if( have_posts() ){
						...
						echo '<h4 class="search_results">' . esc_html__('No posts found in this category', 'rayden') . '</h4>';
					}
				?>
