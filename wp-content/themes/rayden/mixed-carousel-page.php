<?php
/*
Template name: Mixed Carousel Template
*/
...
?>
		...
		<div id="main">
			...
			<div id="main-content">
				...
				<div id="showcase-carousel-holder" class="mixed-carousel disable-drag"> 
					<div id="itemsWrapperLinks">
						...
						<div id="showcase-slider" class="swiper-container">
							<div id="itemsWrapper" class="swiper-wrapper">
							 ...
							 <?php
								...
								while( $rayden_portfolio->have_posts() ){
									...
									$rayden_thumbnail_type		= rayden_get_post_meta( RAYDEN_THEME_OPTIONS, get_the_ID(), 'rayden-opt-portfolio-mixed-carousel-thumbnail-type' );
							...
							<div class="swiper-slide <?php echo sanitize_html_class( $rayden_thumbnail_type ); ?> <?php if( $rayden_bknd_color == "dark-content" ) { echo " change-header"; } ?>">                                    
								<div class="img-mask">
								...
								<div class="trigger-slide-link outer" data-firstline="<?php echo esc_attr( rayden_get_theme_options( 'clapat_rayden_view_project_caption_first' ) ); ?>" data-secondline="<?php echo esc_attr( rayden_get_theme_options( 'clapat_rayden_view_project_caption_second' ) ); ?>">
									<div class="inner">
