<?php
/*
Template name: Vertical Covers Template
*/
...
?>
		...
		<div id="main">
			...
			<div id="main-content">
				...
				<!-- Vertical Covers -->
				<div id="itemsWrapperLinks" class="showcase-list-holder vertical-list <?php if( !rayden_get_theme_options('clapat_rayden_enable_ajax') ) { echo 'thumb-no-ajax'; } ?>">
					...
					<div id="itemsWrapper" class="showcase-list">
							...
							<div class="slide-list hide-ball <?php if( $rayden_bknd_color == "dark-content" ) { echo " change-header"; } ?>">
								...
								<div class="sl-title trigger-slide-link">
									<span><?php echo wp_kses( $rayden_hero_properties->caption_title, 'rayden_allowed_html' ); ?></span>
								</div>
								<div class="sl-subtitle">
									<span><?php echo wp_kses( $rayden_hero_properties->caption_subtitle, 'rayden_allowed_html' ); ?></span>
								</div>
							</div>
