(function() {
    tinymce.create('tinymce.plugins.RaydenShortcodes', {
        init : function(ed, url) {
            ed.addButton('rayden_shortcode_button', {
				type: 'menubutton',
				text: 'B',
				title: 'Insert Rayden Shortcode',
                icon: false,
				...
				menu: [
					...
					// Elements
					{
                        ...
                        menu: [
							...
							{
								text: 'Half Background Container',
								onclick: function () {
									tb_show("Add Half Background Container", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=half_background_container&width=400&height=500');
								}
							},
							...
							
							{
								text: 'Video Hosted',
								onclick: function () {
									tb_show("Add hosted video", ShortcodeAttributes.shortcode_folder + '/shortcodes_popup.php?&sc=rayden_video&width=400&height=500');
								}
							},
		...
		getInfo: function () {
            return {
				...
				longname: 'Rayden Shortcodes',
                author: 'Clapat Studio',
                authorurl: 'http://themeforest.net/user/clapat/',
                infourl: 'http://clapat.ro/themes/rayden-wordpress/',
                version: "1.0"
            }
        }
    });
    // Register plugin
    tinymce.PluginManager.add( 'RaydenShortcodes', tinymce.plugins.RaydenShortcodes );
})();